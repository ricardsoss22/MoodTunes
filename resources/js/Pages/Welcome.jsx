    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
                {/* Navigation */}
                <nav className="relative px-8 py-4 border-b border-gray-800">
                            ...
                            <div className="flex flex-col justify-center">
                                ...
                                <div className="mt-10 flex items-center gap-x-6">
                                    {auth.user ? (
                                        <Link
                                            href={route('dashboard')}
                                            className="rounded-full bg-green-500 px-6 py-3 text-sm font-semibold text-black shadow-lg transition hover:bg-green-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-400"
                                        >
                                            Get Started
                                        </Link>
                                    ) : (
                            ...
                            <div className="grid auto-rows-fr gap-4 sm:gap-6">
                                ...
                                <div className="rounded-xl bg-gray-800 p-6 shadow-lg ring-1 ring-gray-700">
                                    <div className="flex items-center gap-x-4">
                                        <div className="h-12 w-12 flex-none rounded-lg bg-green-500 flex items-center justify-center">
